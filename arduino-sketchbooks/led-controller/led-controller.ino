...
#define PIXELS 144 + 1 // Number of pixels in the string
...
inline void sendPixel(unsigned char r, unsigned char g, unsigned char b)
{
  ...
  // My led strip wants colors in the order R G B
}
...
void saberOn()
{
  ...
  colorWipe(10, 100, 120, 10);
}

void saberOff()
{
  DEBUG_PRINT("Saber off");
  colorRetract(10, 100, 120, 10);
}
...
void colorRetract(unsigned char r, unsigned char g, unsigned char b, unsigned char wait)
{
...
void loop()
{
  if (newModeAvailable)
  {
    ...
    bool onOff = BIT_CHECK(newMode, 7);
    bool saberFlickering = BIT_CHECK(newMode, 6);
    bool rainbowMode = BIT_CHECK(newMode, 5);
    int color = BITMASK_CHECK_ANY(newMode, 0x0F);
